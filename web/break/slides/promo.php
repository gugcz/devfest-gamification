                ...
                <div class="col-md-6">
                    <div class="panel panel-red" style="border-width: 3px;">
                        <div class="panel-body">
                            <?php
                            echo "<img src='http://quest.devfest.cz/images/achievements/230/" . $achievement['nice_image'] . "' style='width: 140px; float: left; margin-right: 20px'>";
...
<script type='text/javascript' src='http://quest.devfest.cz/js/hash.js'></script>
</body>
</html>